...
#ifndef __dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_navigation_core_genivi_navigationcore_routing_adaptor_h__ADAPTOR_MARSHAL_H
#define __dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_navigation_core_genivi_navigationcore_routing_adaptor_h__ADAPTOR_MARSHAL_H
...
public:
    ...
    Routing_adaptor()
    : ::DBus::InterfaceAdaptor("org.genivi.navigation.navigationcore.Routing")
    {
        ...
        register_method(Routing_adaptor, CalculateAlternativeRoutes, _CalculateAlternativeRoutes_stub);
    ...
    ::DBus::IntrospectedInterface *introspect() const 
    {
        ...
        static ::DBus::IntrospectedArgument CalculateAlternativeRoutes_args[] = 
        {
            { "sessionHandle", "u", true },
            { "calculatedRoute", "u", true },
            { "numberOfAlternativeRoutes", "q", true },
            { "error", "i", false },
        ...
        static ::DBus::IntrospectedMethod Routing_adaptor_methods[] = 
        {
            ...
            { "CalculateAlternativeRoutes", CalculateAlternativeRoutes_args },
        ...
        {
            "org.genivi.navigation.navigationcore.Routing",
...
public:
    ...
    virtual void CreateRoute(const uint32_t& sessionHandle, int32_t& error, uint32_t& routeHandle) = 0;
    virtual int32_t DeleteRoute(const uint32_t& sessionHandle, const uint32_t& routeHandle) = 0;
    virtual int32_t SetCostModel(const uint32_t& sessionHandle, const uint32_t& routeHandle, const int32_t& costModel) = 0;
    virtual int32_t GetCostModel(const uint32_t& routeHandle) = 0;
    virtual std::vector< int32_t > GetSupportedCostModels() = 0;
    virtual int32_t SetRoutePreferences(const uint32_t& sessionHandle, const uint32_t& routeHandle, const std::string& countryCode, const std::vector< ::DBus::Struct< int32_t, int32_t > >& roadPreferenceList, const std::vector< ::DBus::Struct< int32_t, int32_t > >& conditionPreferenceList) = 0;
    ...
    virtual int32_t SetTransportationMeans(const uint32_t& sessionHandle, const uint32_t& routeHandle, const std::vector< int32_t >& transportationMeansList) = 0;
    ...
    virtual int32_t SetExcludedAreas(const uint32_t& sessionHandle, const uint32_t& routeHandle, const std::vector< std::vector< ::DBus::Struct< double, double > > >& excludedAreas) = 0;
    virtual std::vector< std::vector< ::DBus::Struct< double, double > > > GetExcludedAreas(const uint32_t& routeHandle) = 0;
    virtual int32_t SetWaypoints(const uint32_t& sessionHandle, const uint32_t& routeHandle, const bool& startFromCurrentPosition, const std::vector< std::map< int32_t, ::DBus::Struct< uint8_t, ::DBus::Variant > > >& waypointsList) = 0;
    ...
    virtual int32_t CalculateRoute(const uint32_t& sessionHandle, const uint32_t& routeHandle) = 0;
    virtual void CancelRouteCalculation(const uint32_t& sessionHandle, const uint32_t& routeHandle) = 0;
    virtual void CalculateAlternativeRoutes(const uint32_t& sessionHandle, const uint32_t& calculatedRoute, const uint16_t& numberOfAlternativeRoutes, int32_t& error, std::vector< uint32_t >& alternativeRoutesList) = 0;
...
private:
    ...
    ::DBus::Message _CreateRoute_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1;
        uint32_t argout2;
        CreateRoute(argin1, argout1, argout2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        wi << argout2;
    ...
    ::DBus::Message _DeleteRoute_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = DeleteRoute(argin1, argin2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _SetCostModel_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = SetCostModel(argin1, argin2, argin3);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _SetRoutePreferences_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = SetRoutePreferences(argin1, argin2, argin3, argin4, argin5);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _SetTransportationMeans_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = SetTransportationMeans(argin1, argin2, argin3);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _SetExcludedAreas_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = SetExcludedAreas(argin1, argin2, argin3);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _SetWaypoints_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = SetWaypoints(argin1, argin2, argin3, argin4);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _CalculateRoute_stub(const ::DBus::CallMessage &call)
    {
        ...
        uint32_t argin1; ri >> argin1;
        uint32_t argin2; ri >> argin2;
        int32_t argout1 = CalculateRoute(argin1, argin2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
    ...
    ::DBus::Message _CalculateAlternativeRoutes_stub(const ::DBus::CallMessage &call)
    {
        ::DBus::MessageIter ri = call.reader();
        ...
        int32_t argout1;
        std::vector< uint32_t > argout2;
        CalculateAlternativeRoutes(argin1, argin2, argin3, argout1, argout2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        wi << argout2;
...
#endif //__dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_navigation_core_genivi_navigationcore_routing_adaptor_h__ADAPTOR_MARSHAL_H
