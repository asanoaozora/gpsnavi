...
#ifndef __dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_map_viewer_genivi_mapviewer_session_adaptor_h__ADAPTOR_MARSHAL_H
#define __dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_map_viewer_genivi_mapviewer_session_adaptor_h__ADAPTOR_MARSHAL_H
...
public:
    ...
    Session_adaptor()
    : ::DBus::InterfaceAdaptor("org.genivi.navigation.mapviewer.Session")
    {
    ...
    ::DBus::IntrospectedInterface *introspect() const 
    {
        ...
        {
            "org.genivi.navigation.mapviewer.Session",
...
public:
    ...
    virtual void CreateSession(const std::string& client, int32_t& error, uint32_t& sessionHandle) = 0;
    virtual int32_t DeleteSession(const uint32_t& sessionHandle) = 0;
...
private:
    ...
    ::DBus::Message _CreateSession_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1;
        uint32_t argout2;
        CreateSession(argin1, argout1, argout2);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        wi << argout2;
    ...
    ::DBus::Message _DeleteSession_stub(const ::DBus::CallMessage &call)
    {
        ...
        int32_t argout1 = DeleteSession(argin1);
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
...
#endif //__dbusxx___home_psa_github_navigation_src_navigation_build_dbus_include_map_viewer_genivi_mapviewer_session_adaptor_h__ADAPTOR_MARSHAL_H
