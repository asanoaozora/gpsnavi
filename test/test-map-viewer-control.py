...
session = bus.get_object('org.genivi.navigation','/org/genivi/navigation/mapviewer')
...
#sessionhandle=ret[1]
sessionhandle=1 #session is already created by default
...
MapViewerControl_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/mapviewer')
...
mapviewerhandle=1 #map view instance is already created by default
