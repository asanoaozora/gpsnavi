...
def createMapView():
    ...
    g_mapviewer_sessionhandle=1 #session is already created by default
    ...
    g_mapviewer_maphandle=1 #map view instance is already created by default    
...
navigationcore_session_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/navigationcore')
...
guidance_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/navigationcore')
g_guidance_interface = dbus.Interface(guidance_obj, dbus_interface='org.genivi.navigation.navigationcore.Guidance')

mapviewer_session_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/mapviewer')
...
g_mapviewercontrol_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/mapviewer')
...
g_mapmatchedposition_obj = bus.get_object('org.genivi.navigation','/org/genivi/navigation/navigationcore')
...
g_navigationcore_session_handle=1 #session is already created by default
